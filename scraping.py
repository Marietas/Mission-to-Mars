...
#Create a new dictionary to hold a list of dic with the urls string and title of each hemisphere image
# routine to scrape all functions
def scrape_all():
...
def featured_image(browser):
    ...
    full_image_element = 'https://d2pn8kiwq2w21t.cloudfront.net/images/jpegPIA24419.2e16d0ba.fill-400x400-c50.jpg'
    ...
    try:
        ...
        img_url_rel = img_soup.find('img', class_='BaseImage')['src']
